...
def run(): 
    ...
    valid_dataset = dataset.BERTDataset(
        review=df_valid.original_text.values, target=df_valid.label.values
    ...
    for epoch in range(config.EPOCHS):
        ...
        with open(config.TRAIN_LOG, 'a') as fname:
            fname.write('Epoch '+ str(epoch) + ': Accuracy ' + str(accuracy))
            fname.write('   Time completed: ' + datetime.datetime.now().ctime())
            fname.write("\n")
